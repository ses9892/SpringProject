				...
				<table id="mytable" class="table table-bordred table-striped table-hover">
					<thead>
						<tr>
							...
							<th style="width: 100px; text-align: center;">판매자</th>
				    ...
				    <tbody>
						...
						<tr>
							<td colspan="10"><marquee>테이블에 저장된 글이 없습니다.</marquee></td>
						</tr>
						...
						<tr style="cursor: pointer;">
							...
							<td align="center">${vo.sh_seller}</td>
					    	...
					    	<td align="center">
						    	<p data-placement="top" data-toggle="tooltip" title="Delete">
							    	<button class="btn btn-danger btn-xs" data-title="Delete" data-toggle="modal" data-target="#delete" onclick="location.href='ShopDeleteProductOK?sh_idx=${vo.sh_idx}&flag=adminPage'" >
